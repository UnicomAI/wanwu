...
// ServerInterceptor 拦截器结构体 [EN] ServerInterceptor interceptor structure
type ServerInterceptor struct{}

// Unary 拦截服务方法的处理 [EN] Unary interception service method processing
func (si *ServerInterceptor) Unary() grpc.UnaryServerInterceptor {
	return func(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (interface{}, error) {
		...
		// 调用原始的处理函数 [EN] Call the original handler function
