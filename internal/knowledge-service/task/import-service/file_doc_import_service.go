...
// checkOneFile single file check
func checkOneFile(ctx context.Context, importTask *model.KnowledgeImportTask, doc *model.DocInfo, fileTypeMap map[string]bool) (bool, string) {
	...
	//3. Document duplicate name verification
...
// checkCompressedFile checks whether it is a compressed file
...
// buildDocList constructs a document list
