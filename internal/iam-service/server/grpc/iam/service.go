...
func (s *Service) InitData() error {
	...
	// The only top-level organization built into the system (all first-level organizations are mounted)
	...
	// Built-in administrator role for top-level organizations in the system
