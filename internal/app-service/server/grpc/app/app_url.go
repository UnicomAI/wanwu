...
// AppUrlCreate 创建智能体Url [EN] AppUrlCreate creates the agent Url
func (s *Service) AppUrlCreate(ctx context.Context, req *app_service.AppUrlCreateReq) (*emptypb.Empty, error) {
	...
	// 调用client方法创建智能体Url [EN] Call the client method to create the agent Url
...
// AppUrlDelete 删除智能体Url [EN] AppUrlDelete deletes the agent Url
func (s *Service) AppUrlDelete(ctx context.Context, req *app_service.AppUrlDeleteReq) (*emptypb.Empty, error) {
	// 调用client方法删除智能体Url [EN] Call the client method to delete the agent Url
...
// AppUrlUpdate 修改智能体Url [EN] AppUrlUpdate Modifies the agent Url
func (s *Service) AppUrlUpdate(ctx context.Context, req *app_service.AppUrlUpdateReq) (*emptypb.Empty, error) {
	// 调用client方法更新智能体Url [EN] Call the client method to update the agent Url
...
// GetAppUrlList 智能体Url列表 [EN] GetAppUrlList Agent Url list
...
func (s *Service) GetAppUrlInfoBySuffix(ctx context.Context, req *app_service.GetAppUrlInfoBySuffixReq) (*app_service.AppUrlInfo, error) {
	// 获取现有智能体Url信息 [EN] Get existing agent Url information
...
// AppUrlStatusSwitch AppUrl开关 [EN] AppUrlStatusSwitch AppUrl switch
