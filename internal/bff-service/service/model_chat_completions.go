...
func ModelChatCompletions(ctx *gin.Context, modelID string, req *mp_common.LLMReq) {
	...
	var (
		firstFlag = false // 思维链起始标识符，默认思维链未开始 [EN] The starting identifier of the thinking chain. The default thinking chain has not started.
		endFlag   = false // 思维链结束标识符，默认思维链未结束 [EN] The end identifier of the thinking chain. The default thinking chain is not ended.
	)
