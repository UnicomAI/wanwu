...
//
//	@Tags			safety
//	@Summary		创建敏感词表 [EN] @Summary Create a sensitive word list
//	@Description	创建敏感词表 [EN] @Description Create a sensitive word list
//	@Security		JWT
//	@Accept			json
//	@Produce		json
//	@Param			data	body		request.CreateSensitiveWordTableReq	true	"创建敏感词表请求参数" [EN] @Param data body request.CreateSensitiveWordTableReq true "Create sensitive word table request parameters"
...
//
//	@Tags			safety
//	@Summary		编辑敏感词表 [EN] @Summary Edit sensitive word list
//	@Description	编辑敏感词表 [EN] @Description Edit sensitive word list
//	@Security		JWT
//	@Accept			json
//	@Produce		json
//	@Param			data	body		request.UpdateSensitiveWordTableReq	true	"编辑敏感词表请求参数" [EN] @Param data body request.UpdateSensitiveWordTableReq true "Edit sensitive word table request parameters"
...
//
//	@Tags			safety
//	@Summary		删除敏感词表 [EN] @Summary Delete sensitive word list
//	@Description	删除敏感词表 [EN] @Description Delete sensitive word list
//	@Security		JWT
//	@Accept			json
//	@Produce		json
//	@Param			data	body		request.DeleteSensitiveWordTableReq	true	"删除敏感词表请求参数" [EN] @Param data body request.DeleteSensitiveWordTableReq true "Delete sensitive word table request parameter"
//	@Success		200		{object}	response.Response
...
//
//	@Tags			safety
//	@Summary		获取敏感词表列表 [EN] @Summary Get a list of sensitive words
//	@Description	获取敏感词表列表 [EN] @Description Get the list of sensitive words
//	@Security		JWT
//	@Accept			json
//	@Produce		json
...
//
//	@Tags			safety
//	@Summary		获取词表数据列表 [EN] @Summary Get the vocabulary data list
//	@Description	获取词表数据列表 [EN] @Description Get the vocabulary data list
//	@Security		JWT
//	@Accept			json
//	@Produce		json
//	@Param			data		query		request.GetSensitiveVocabularyReq	true	"查询词表数据列表参数" [EN] @Param data query request.GetSensitiveVocabularyReq true "Query vocabulary data list parameters"
...
//
//	@Tags			safety
//	@Summary		上传敏感词 [EN] @Summary Upload sensitive words
//	@Description	上传敏感词 [EN] @Description Upload sensitive words
//	@Security		JWT
//	@Accept			json
//	@Produce		json
//	@Param			data	body		request.UploadSensitiveVocabularyReq	true	"上传敏感词参数" [EN] @Param data body request.UploadSensitiveVocabularyReq true "Upload sensitive word parameters"
//	@Success		200		{object}	response.Response
...
//
//	@Tags			safety
//	@Summary		删除敏感词 [EN] @Summary Delete sensitive words
//	@Description	删除敏感词 [EN] @Description Delete sensitive words
//	@Security		JWT
//	@Accept			json
//	@Produce		json
//	@Param			data	body		request.DeleteSensitiveVocabularyReq	true	"删除敏感词参数" [EN] @Param data body request.DeleteSensitiveVocabularyReq true "Delete sensitive word parameters"
//	@Success		200		{object}	response.Response
...
//
//	@Tags			safety
//	@Summary		编辑回复设置 [EN] @Summary Edit reply settings
//	@Description	编辑回复设置 [EN] @Description Edit reply settings
//	@Security		JWT
//	@Accept			json
//	@Produce		json
//	@Param			data	body		request.UpdateSensitiveWordTableReplyReq	true	"编辑回复设置请求参数" [EN] @Param data body request.UpdateSensitiveWordTableReplyReq true "Edit reply set request parameters"
//	@Success		200		{object}	response.Response
...
//
//	@Tags			safety
//	@Summary		获取敏感词表列表（用于下拉选择） [EN] @Summary Get a list of sensitive words (for drop-down selection)
//	@Description	获取敏感词表列表（用于下拉选择） [EN] @Description Get the list of sensitive words (for drop-down selection)
//	@Security		JWT
//	@Accept			json
//	@Produce		json
//	@Success		200	{object}	response.Response{data=response.ListResult{list=[]response.SensitiveWordTableDetail}}
...
//
//	@Tags			safety
//	@Summary		获取敏感词表 [EN] @Summary Get the sensitive word list
//	@Description	获取敏感词表 [EN] @Description Get the sensitive word list
//	@Security		JWT
//	@Accept			json
//	@Produce		json
//	@Param			data	query		request.GetSensitiveVocabularyReq	true	"查询敏感词表参数" [EN] @Param data query request.GetSensitiveVocabularyReq true "Query sensitive vocabulary parameters"
