...
//
//	@Tags			mcp
//	@Summary Create a custom MCP
//	@Description Create a custom MCP
//	@Accept			json
//	@Produce		json
//	@Param data body request.MCPCreate true "Customized MCP information"
...
//
//	@Tags			mcp
//	@Summary Modify custom MCP
//	@Description Modify custom MCP
//	@Accept			json
//	@Produce		json
//	@Param data body request.MCCPupdate true "Customized MCP information"
//	@Success		200		{object}	response.Response{}
//	@Router			/mcp [put]
...
//
//	@Tags			mcp
//	@Summary Get custom MCP details
//	@Description Get custom MCP details
//	@Accept			json
//	@Produce		json
...
//
//	@Tags			mcp
//	@Summary Delete custom MCP
//	@Description Delete custom MCP
//	@Accept			json
//	@Produce		json
...
//
//	@Tags			mcp
//	@Summary Get a custom MCP list
//	@Description Get custom MCP list
//	@Accept			json
//	@Produce		json
...
//
//	@Tags			mcp
//	@Summary Get the MCP Tool list
//	@Description Get the MCP Tool list
//	@Accept			json
//	@Produce		json
//	@Param mcpId query string false "mcpId (pass the same one as serverUrl)"
//	@Param serverUrl query string false "serverUrl, which is sseUrl (pass the same as mcpId)"
...
//
//	@Tags			mcp
//	@Summary Get a custom MCP list (for drop-down selection)
//	@Description Get a custom MCP list (for drop-down selection)
//	@Accept			json
//	@Produce		json
//	@Param name query string false "mcp name"
...
//
//	@Tags			mcp
//	@Summary Get the MCP Action list
//	@Description Get MCP Action list
//	@Accept			json
//	@Produce		json
//	@Param data query request.MCPActionListReq true "mcp information"
