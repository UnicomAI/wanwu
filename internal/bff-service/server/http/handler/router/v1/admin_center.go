...
func registerAdminCenter(apiV1 *gin.RouterGroup) {
	...
	// knowledge
	mid.Sub("admin_center").Reg(apiAdminCenter, "/knowledge/page/list", http.MethodPost, v1.AdminKnowledgePageList, "知识库全局列表", middleware.AuthAdminCenter(middleware.AdminOrgCheck, knowledgeBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/knowledge/base", http.MethodPost, v1.AdminKnowledgeBase, "知识库基础信息", middleware.AuthAdminCenter(middleware.AdminBizCheck, knowledgeBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/knowledge/file/list", http.MethodPost, v1.AdminKnowledgeFileList, "知识库文档列表", middleware.AuthAdminCenter(middleware.AdminBizCheck, knowledgeBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/knowledge/qa/pair/list", http.MethodPost, v1.AdminKnowledgeQAPairList, "问答对列表", middleware.AuthAdminCenter(middleware.AdminBizCheck, knowledgeBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/knowledge/file/detail", http.MethodPost, v1.AdminKnowledgeFileDetail, "知识库文档详情", middleware.AuthAdminCenter(middleware.AdminBizCheck, knowledgeBiz))
	// workflow
	mid.Sub("admin_center").Reg(apiAdminCenter, "/workflow/page/list", http.MethodPost, v1.AdminWorkflowPageList, "工作流分页列表", middleware.AuthAdminCenter(middleware.AdminOrgCheck, workflowBiz))
	// skill
	mid.Sub("admin_center").Reg(apiAdminCenter, "/skill/page/list", http.MethodPost, v1.AdminSkillPageList, "skill分页列表", middleware.AuthAdminCenter(middleware.AdminOrgCheck, skillBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/skill/base", http.MethodPost, v1.AdminSkillBase, "skill详情", middleware.AuthAdminCenter(middleware.AdminBizCheck, skillBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/skill/detail", http.MethodPost, v1.AdminSkillDetail, "skill详情", middleware.AuthAdminCenter(middleware.AdminBizCheck, skillBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/skill/version/list", http.MethodPost, v1.AdminSkillVersionList, "已发布skill版本列表", middleware.AuthAdminCenter(middleware.AdminBizCheck, skillBiz))
	//model 模型管理
	mid.Sub("admin_center").Reg(apiAdminCenter, "/model/page/list", http.MethodPost, v1.AdminModelPageList, "模型全局列表", middleware.AuthAdminCenter(middleware.AdminOrgCheck, modelBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/model/base", http.MethodPost, v1.AdminModelBase, "模型基础信息", middleware.AuthAdminCenter(middleware.AdminBizCheck, modelBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/model/detail", http.MethodPost, v1.AdminModelDetail, "模型详情", middleware.AuthAdminCenter(middleware.AdminBizCheck, modelBiz))
	//rag 知识问答
	...
	mid.Sub("admin_center").Reg(apiAdminCenter, "/mcp/custom/detail", http.MethodPost, v1.AdminMCPDetail, "导入MCP详情", middleware.AuthAdminCenter(middleware.AdminBizCheck, mcpBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/mcp/server/detail", http.MethodPost, v1.AdminMCPServerDetail, "创建MCP详情", middleware.AuthAdminCenter(middleware.AdminBizCheck, mcpBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/mcp/tool/list", http.MethodPost, v1.AdminMCPToolList, "MCP工具列表", middleware.AuthAdminCenter(middleware.AdminBizCheck, mcpBiz))
	// tool
	mid.Sub("admin_center").Reg(apiAdminCenter, "/tool/page/list", http.MethodPost, v1.AdminToolPageList, "工具全局列表", middleware.AuthAdminCenter(middleware.AdminOrgCheck, toolBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/tool/base", http.MethodPost, v1.AdminToolBase, "工具基础信息", middleware.AuthAdminCenter(middleware.AdminBizCheck, toolBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/tool/detail", http.MethodPost, v1.AdminToolDetail, "工具详情", middleware.AuthAdminCenter(middleware.AdminBizCheck, toolBiz))
	// prompt
	mid.Sub("admin_center").Reg(apiAdminCenter, "/prompt/page/list", http.MethodPost, v1.AdminPromptPageList, "提示词全局列表", middleware.AuthAdminCenter(middleware.AdminOrgCheck, promptBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/prompt/base", http.MethodPost, v1.AdminPromptBase, "提示词基础信息", middleware.AuthAdminCenter(middleware.AdminBizCheck, promptBiz))
	mid.Sub("admin_center").Reg(apiAdminCenter, "/prompt/detail", http.MethodPost, v1.AdminPromptDetail, "提示词详情", middleware.AuthAdminCenter(middleware.AdminBizCheck, promptBiz))
	// assistant
	...
	mid.Sub("admin_center").Reg(apiAdminCenter, "/sensitive/detail", http.MethodPost, v1.AdminSensitiveWordDetail, "敏感词业务详情", middleware.AuthAdminCenter(middleware.AdminBizCheck, sensitiveWordBiz))
}
