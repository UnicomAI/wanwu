...
func Register(openAPI *gin.RouterGroup) {
	...
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent", http.MethodPut, openapi.UpdateAgent, "更新智能体基本信息OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent", http.MethodDelete, openapi.DeleteAgent, "删除智能体OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/list", http.MethodGet, openapi.ListAgents, "智能体列表OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/info", http.MethodGet, openapi.GetAgentInfo, "获取智能体详情OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/config", http.MethodPut, openapi.UpdateAgentConfig, "更新智能体配置OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthModelByUuid([]string{"modelConfig.modelId", "rerankConfig.modelId", "recommendConfig.modelConfig.modelId"}))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/publish", http.MethodPost, openapi.PublishAgent, "发布智能体OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	// agent — 已发布对话管理
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/conversation", http.MethodPost, openapi.CreateAgentConversation, "智能体创建对话OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/conversation", http.MethodDelete, openapi.DeleteAgentConversation, "删除智能体对话OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/conversation/list", http.MethodGet, openapi.ListAgentConversations, "智能体对话列表OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/conversation/detail", http.MethodGet, openapi.GetAgentConversationDetail, "智能体对话历史消息OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/conversation/clear", http.MethodDelete, openapi.ClearAgentConversation, "清空智能体对话历史OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	// agent — 草稿态对话管理
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/conversation/draft/detail", http.MethodGet, openapi.GetAgentDraftConversationDetail, "草稿智能体对话历史消息OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/agent/conversation/draft", http.MethodDelete, openapi.DeleteAgentDraftConversation, "删除草稿智能体对话历史OpenAPI", constant.OpenAPITypeAgent,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppAgent, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	// agent — 问答
	...
	// workflow
	mid.Sub("openapi").RegWithAPIType(openAPI, "/workflow/run", http.MethodPost, openapi.WorkflowRun, "工作流OpenAPI", constant.OpenAPITypeWorkflow,
		append([]gin.HandlerFunc{middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppWorkflow, middleware.WithAppResource(constant.AppTypeWorkflow, "uuid"))}, middleware.APIKeyRecord(middleware.RecordNonStreamType))...)
	...
	mid.Sub("openapi").RegWithAPIType(openAPI, "/chatflow/chat", http.MethodPost, openapi.ChatflowChat, "对话流OpenAPI", constant.OpenAPITypeChatflow,
		append([]gin.HandlerFunc{middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleAppWorkflow, middleware.WithAppResource(constant.AppTypeChatflow, "uuid"))}, middleware.APIKeyRecord(middleware.RecordStreamType))...)
	...
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/parseTemplate", http.MethodGet, openapi.GetParseTemplateList, "查询解析模板列表", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	...
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/import", http.MethodPost, openapi.ImportDoc, "上传文档", constant.OpenAPITypeKnowledge,
		append([]gin.HandlerFunc{middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleResourceKnowledge, middleware.WithKnowledgeResource("knowledgeId"))}, middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledge("knowledgeId", middleware.KnowledgeEdit))...)
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/update/config", http.MethodPost, openapi.UpdateDocConfig, "更新文档配置", constant.OpenAPITypeKnowledge,
		append([]gin.HandlerFunc{middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleResourceKnowledge, middleware.WithKnowledgeResource("knowledgeId"))}, middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledge("knowledgeId", middleware.KnowledgeEdit))...)
	...
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/hit", http.MethodPost, openapi.KnowledgeHit, "知识库命中测试", constant.OpenAPITypeKnowledge,
		append([]gin.HandlerFunc{middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleResourceKnowledge, middleware.WithKnowledgeHitResource())}, middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthModelByUuid([]string{"knowledgeMatchParams.rerankModelId"}))...)
	...
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/status/update", http.MethodPost, openapi.UpdateDocSegmentStatus, "更新分段状态", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledgeDoc("docId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/labels", http.MethodPost, openapi.UpdateDocSegmentLabels, "更新文档切片标签", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledgeDoc("docId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/create", http.MethodPost, openapi.CreateDocSegment, "新增文档切片", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledgeDoc("docId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/batch/create", http.MethodPost, openapi.BatchCreateDocSegment, "批量新增文档切片", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledgeDoc("docId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/update", http.MethodPost, openapi.UpdateDocSegment, "更新文档切片", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledgeDoc("docId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/delete", http.MethodDelete, openapi.DeleteDocSegment, "删除文档切片", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledgeDoc("docId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/child/create", http.MethodPost, openapi.CreateDocChildSegment, "创建子分段", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledgeDoc("docId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/child/update", http.MethodPost, openapi.UpdateDocChildSegment, "更新子分段", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledgeDoc("docId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/child/delete", http.MethodDelete, openapi.DeleteDocChildSegment, "删除子分段", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledgeDoc("docId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/segment/image/upload", http.MethodPost, openapi.UploadDocSegmentImage, "分段图片上传", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledge("knowledgeId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/meta/list", http.MethodGet, openapi.GetKnowledgeMetaKeyList, "获取知识库元数据key列表", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledge("knowledgeId", middleware.KnowledgeView))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/meta/update", http.MethodPost, openapi.UpdateKnowledgeMetaKey, "定义知识库元数据key", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledge("knowledgeId", middleware.KnowledgeEdit))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/meta/list", http.MethodPost, openapi.GetKnowledgeDocMetaValueList, "获取文档元数据值列表", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledge("knowledgeId", middleware.KnowledgeView))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/knowledge/doc/meta/update", http.MethodPost, openapi.UpdateKnowledgeDocMetaValue, "更新文档元数据值", constant.OpenAPITypeKnowledge, middleware.AuthOpenAPIKey(), middleware.APIKeyRecord(middleware.RecordNonStreamType), middleware.AuthKnowledge("knowledgeId", middleware.KnowledgeEdit))
	...
	// 对话管理
	mid.Sub("openapi").RegWithAPIType(openAPI, "/wga/conversation", http.MethodPost, openapi.CreateWGAConversation, "创建WGA对话", constant.OpenAPITypeWGA,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleWGA, middleware.WithModuleCreatorFromContext()), middleware.AuthModelByUuid([]string{"modelUuid"}), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/wga/conversation", http.MethodDelete, openapi.DeleteWGAConversation, "删除WGA对话", constant.OpenAPITypeWGA,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleWGA, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/wga/conversation/list", http.MethodGet, openapi.GetWGAConversationList, "WGA对话列表", constant.OpenAPITypeWGA,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleWGA, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/wga/conversation/detail", http.MethodGet, openapi.GetWGAConversationDetail, "WGA对话详情", constant.OpenAPITypeWGA,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleWGA, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	// 聊天交互
	mid.Sub("openapi").RegWithAPIType(openAPI, "/wga/conversation/chat", http.MethodPost, openapi.WGAConversationChat, "WGA对话流", constant.OpenAPITypeWGA,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleWGA, middleware.WithModuleCreatorFromContext()), middleware.AuthModelByUuid([]string{"modelUuid"}), middleware.APIKeyRecord(middleware.RecordStreamType))
	// 人工介入
	...
	// 工作区文件
	mid.Sub("openapi").RegWithAPIType(openAPI, "/wga/conversation/workspace", http.MethodGet, openapi.GetWGAWorkspace, "WGA工作区目录树", constant.OpenAPITypeWGA,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleWGA, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
	mid.Sub("openapi").RegWithAPIType(openAPI, "/wga/conversation/workspace/download", http.MethodGet, openapi.WGAWorkspaceDownload, "WGA工作区文件下载", constant.OpenAPITypeWGA,
		middleware.AuthOpenAPIKey(), middleware.TraceOpenAPI(constant.BizModuleWGA, middleware.WithModuleCreatorFromContext()), middleware.APIKeyRecord(middleware.RecordNonStreamType))
}
