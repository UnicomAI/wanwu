...
export default {
  ...
  knowledgeManage: {
    ...
    parseTemplate: {
      ...
      paramSetting: '参数设置',
      save: '保存',
      deleteConfirm: '确认删除该解析模板？',
      nameRequired: '请输入模板名称',
      emptyTip: '暂无模板，点击“新建模板”创建',
    },
    keyWordConfig: '关键词配置',
    keyWordTip:
    ...
    create: {
      ...
      createChunk: '新增分段',
      addChildChunk: '新增子分段',
      saveAndReparseChild: '保存并重新解析子分段',
      deleteChildChunkTips: '确定要删除这个子分段吗？',
      chunkContent: '分段内容',
    ...
    config: {
      ...
      OCRAnalysisDesc: '基于OCR模型，统一解析PDF/Word/PPT等文档内全类型内容',
      OCRModel: 'OCR模型',
  ...
  agent: {
    ...
    feedbackDialogTitle: '反馈意见',
    feedbackPlaceholder: '请输入具体反馈意见（选填）',
    ...
    log: {
      ...
      conversationTitlePlaceholder: '输入会话标题搜索',
      source: '来源',
      ...
      exportAll: '导出全部',
      exportSelected: '导出已选',
      exportSuccess: '导出任务已创建，请在导出记录中查看进度。',
      selectLogsFirst: '请先选择需要导出的对话日志',
      exportRecord: {
        title: '导出记录',
        exportTime: '导出时间',
        fileName: '文件名称',
  ...
  channel: {
    ...
    reScanBind: '重新扫码绑定',
    scanDialog: {
      wechatScanTitle: '微信扫码连接',
      dingtalkScanTitle: '钉钉扫码连接',
      hint: '二维码有效期倒计时：{time} 秒',
      waiting: '等待扫码中...',
      refresh: '刷新二维码',
      expiredMsg: '二维码已过期，请重新获取',
      failedMsg: '连接失败，请重试',
      wechatSuccess: '微信连接成功！',
      dingtalkSuccess: '钉钉连接成功！',
      retry: '重试',
      done: '完成',
    },
  },
    ...
    skill: {
      ...
      skillWorkBench: {
        ...
        fileTree: {
          ...
          copySuccess: '路径已复制',
          copyFailed: '复制路径失败',
          invalidName: '名称不能为空，且不能包含路径分隔符或 .git',
          directoryUnavailable: '目标文件夹不可用',
          createFailed: '创建失败',
          createSuccess: '创建成功',
          renameFailed: '重命名失败',
          renameSuccess: '重命名成功',
          unsavedRenameWarning:
            '当前目录/文件下有未保存的内容，请保存之后再重命名',
          uploadFailed: '上传失败',
          uploadSuccess: '上传成功',
          directoryUploadNotSupported: '不支持上传目录，请选择文件或压缩包',
          name: '请输入',
        },
        search: {
          placeholder: '搜索',
        ...
        quickPublish: {
          title: '提交修改并发布',
          scopeDescription:
            '发布前需要提交当前工作区的所有修改，请确认以下暂存和未暂存的修改是否提交并发布。',
          version: '发布版本',
          scope: '发布范围',
          versionDescription: '版本描述',
          changeScope: '提交范围（{count} 个文件）',
          viewDetails: '前往版本管理查看修改详情',
          unstagedChanges: '未暂存的修改（{count}）',
          stagedChanges: '已暂存的修改（{count}）',
          commitMessage: '提交说明',
          commitMessagePlaceholder: '请输入提交说明',
          commitMessageRequired: '请输入提交说明',
          confirmSubmit: '确认提交并发布',
          submitting: '正在提交并发布…',
          retryPublish: '重试发布',
          retryingPublish: '正在重新发布…',
          publishFailedTitle: '修改已提交，但发布失败',
          publishFailedDescription: '你可以直接重试发布，不会重复创建提交。',
          scopeChanged: '工作区内容已发生变化，请重新查看后确认。',
          unsavedFiles: '还有文件未保存，请先保存文件后再发布。',
          changeTypes: {
            added: '新增',
            untracked: '新增',
            modified: '修改',
  ...
  adminCenter: {
    ...
    common: {
      ...
      org: '所属组织',
      updateTime: '更新时间',
      visibleUsers: '可见用户列表（共{count}人）',
      orgStructure: '组织架构',
      searchOrg: '搜索组织',
      selectedOrgs: '已选中{count}个组织',
      status: '状态',
      enabled: '已开启',
      disabled: '未开启',
    },
    ...
    placeholders: {
      modelName: '输入模型名称搜索',
      knowledgeName: '输入知识库名称搜索',
      skillName: '输入skill名称搜索',
      safetyName: '输入安全护栏名称搜索',
      agentName: '输入智能体名称搜索',
      mcpName: '输入MCP名称搜索',
      toolName: '输入工具名称搜索',
      ragName: '输入知识问答名称搜索',
      workflowName: '输入工作流名称搜索',
      promptName: '输入提示词名称搜索',
    },
    group: {
      globalManage: '全局管理',
      productBackend: '产品后台',
    ...
    pageModules: {
      ...
      modelService: {
        ...
        detail: {
          ...
          vision: 'Vision',
          contextLength: '模型上下文长度',
          maxToken: 'Max_token',
          inferenceUrl: '推理URL',
          reasoningSwitch: '深度思考开关',
          draft: '草稿',
          published: '已发布',
          textGeneration: '文本生成',
          specificUsers: '特定用户',
      ...
      appDevelopment: {
        ...
        agent: {
          ...
          detail: {
            ...
            rerankModel: 'Rerank模型',
            topK: 'TopK',
            scoreThreshold: 'Score阈值',
            maxHistory: '最长上下文',
            semanticsPriority: '语义权重',
            keywordPriority: '关键词权重',
            useGraph: '知识图谱',
            maxHistoryLength: '上下文记忆轮数',
            prologue: '开场白',
            recommendQuestion: '推荐问题',
            temperature: '温度',
            topP: '多样性',
            ...
            recommendModel: '追问模型',
            promptEnable: '提示词',
            recommendPrompt: '追问提示词',
            sensitiveTables: '敏感词库',
            matchTypeOptions: {
              vector: '向量检索',
              text: '全文检索',
              mix: '混合检索',
  ...
  messageCenter: {
    ...
    deleteConfirm: '删除所选消息后不可恢复，是否确认删除？',
