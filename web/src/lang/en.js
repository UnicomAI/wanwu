...
export default {
  ...
  statisticsDashboard: {
    ...
    resContent: '响应内容',
    finishReason: '结束原因',
    modelTypeLabel: 'Model Type Label',
    ...
    modelDimensionDesc: 'Statistics by model dimension',
    appDimension: 'Application dimension',
    appDimensionDesc: 'Statistics by application dimension',
    apiDimension: 'API call',
    apiDimensionDesc: 'Statistics by API call',
    published: 'Published by me',
    used: 'Used by me',
    visualCharts: 'Visual Charts',
    statisticsOverview: 'Statistics Overview',
    manage: 'Manage',
    manageConfig: 'Configure Statistics Modules',
    manageConfigTips:
      'Select the modules to display and drag to adjust the order',
    atLeastOneModule: 'Please select at least one module',
    modelTokenUsageChart: 'Model Token Usage Statistics',
    modelCallTrendChart: 'Model Call Trend Chart',
    modelRankingByModel: 'Model Token Usage Ranking (Model)',
    modelRankingByUser: 'Model Token Usage Ranking (User)',
    modelRankingByOrg: 'Model Token Usage Ranking (Org)',
    appFailureLineName: 'App Call Failure Trend Chart',
    appRankingByAgent: 'Agent Usage Ranking',
    appRankingByWorkflow: 'Workflow Usage Ranking',
    appRankingByChat: 'Chatflow Usage Ranking',
    appRankingByRag: 'Knowledge Q&A Usage Ranking',
  },
  statistics: {
    title: '统计分析',
    overview: '数据概况',
