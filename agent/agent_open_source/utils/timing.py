...
def advanced_timing_decorator(task_name: Optional[str] = None,
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs) -> Any:
            ...
            # If the return value is a generator, wrap it to record streaming statistics
            if inspect.isgenerator(result):
                ...
                # Non-generator function: directly record the total time taken
                total_time = time.perf_counter() - start_time
                # log_msg = ""
...
# Preset decorators for different log levels
...
if __name__ == "__main__":
    ...
    # Test streaming generator functions
