...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OpenAPIUpdateRagRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OpenAPICreateRagRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.OpenAPICreateRagResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OpenAPIRagDraftChatRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OpenAPIRagConfigUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OpenAPIRagCreateConversationRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.OpenAPIRagCreateConversationResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/rag/conversation/draft": {
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "问答明细ID（不传则删除整条草稿会话）",
                        "name": "detail_id",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.OpenAPIRagListResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OpenAPIRagPublishRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OpenAPIWgaCreateConversationReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OpenAPIWgaConversationChatReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/wga/conversation/workspace/download": {
            "get": {
                "security": [
                    {
                        "OpenAPIKey": []
    ...
    "definitions": {
        ...
        "request.DocListReq": {
            ...
            "properties": {
                ...
                "metaEndTime": {
                    "description": "metaType=time 时的结束时间戳(毫秒，字符串)",
                    "type": "string"
                },
                "metaStartTime": {
                    "description": "metaType=time 时的起始时间戳(毫秒，字符串)",
                    "type": "string"
                },
                "metaType": {
                    "description": "元数据类型：string/number/time，为空时按旧逻辑(metaValue 模糊匹配，排除 time)",
                    "type": "string"
                },
                "metaValue": {
                    "description": "元数据值，metaType 为 string/number 时使用",
                    "type": "string"
                },
                "pageNo": {
                    "type": "integer"
        ...
        "request.OpenAPICreateRagRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "request.OpenAPIRagChatRequest": {
            ...
            "properties": {
                "conversation_id": {
                    "description": "由创建会话接口获取，口径与页面侧一致：已发布问答必须先建会话",
                    "type": "string"
                },
                "file_info": {
                    "description": "随问题携带的文件，当前仅支持 1 张图片(png/jpg/jpeg)",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.ConversionStreamFile"
                    }
        ...
        "request.OpenAPIRagConfigUpdateRequest": {
            "type": "object",
            "required": [
                "uuid"
            ],
            "properties": {
                ...
                "modelConfig": {
                    "description": "对话模型，modelId 传模型UUID",
                    "allOf": [
                        {
                            "$ref": "#/definitions/request.AppModelConfig"
                        }
                ...
                "qaRerankConfig": {
                    "description": "问答库Rerank模型，modelId 传模型UUID",
                    "allOf": [
                        {
                            "$ref": "#/definitions/request.AppModelConfig"
                        }
                ...
                "rerankConfig": {
                    "description": "知识库Rerank模型，modelId 传模型UUID",
                    "allOf": [
                        {
                            "$ref": "#/definitions/request.AppModelConfig"
                        }
        ...
        "request.OpenAPIRagCreateConversationRequest": {
            "type": "object",
            "required": [
                "title",
                "uuid"
        ...
        "request.OpenAPIRagDraftChatRequest": {
            "type": "object",
            "required": [
                "query",
                "uuid"
        ...
        "request.OpenAPIRagPublishRequest": {
            "type": "object",
            "required": [
                "desc",
                "publishType",
        ...
        "request.OpenAPIUpdateRagRequest": {
            "type": "object",
            "required": [
                "name",
                "uuid"
        ...
        "request.OpenAPIWgaConversationChatReq": {
            "type": "object",
            "required": [
                "messages",
                "threadId"
            ...
            "properties": {
                "agentId": {
                    "description": "智能体ID，可选，为空时使用默认Supervisor",
                    "type": "string"
                },
                "messages": {
                    "description": "消息列表",
        ...
        "request.OpenAPIWgaCreateConversationReq": {
            "type": "object",
            "required": [
                "modelUuid",
                "title"
        ...
        "response.GeneralAgentConversationInfo": {
            ...
            "properties": {
                ...
                "isSkillConversation": {
                    "description": "是否为skill对话",
                    "type": "boolean"
                },
                "previewId": {
                    "description": "skill preview conversation ID",
                    "type": "string"
                },
                "skillId": {
        ...
        "response.OpenAPICreateRagResponse": {
            "type": "object",
            "properties": {
                "uuid": {
                    "type": "string"
        ...
        "response.OpenAPIRagCreateConversationResponse": {
            "type": "object",
            "properties": {
                "conversation_id": {
                    "type": "string"
        ...
        "response.OpenAPIRagListResponse": {
            "type": "object",
            "properties": {
                "list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.OpenAPIRagBriefInfo"
                    }
                }
            }
        },
