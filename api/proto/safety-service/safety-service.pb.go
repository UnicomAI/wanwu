...
type CreateSensitiveWordTableReq struct {
	...
	TableName string `protobuf:"bytes,3,opt,name=tableName,proto3" json:"tableName,omitempty"` // Sensitive word list name
...
type UpdateSensitiveWordTableReq struct {
	...
	OrgId     string `protobuf:"bytes,1,opt,name=orgId,proto3" json:"orgId,omitempty"`
	UserId    string `protobuf:"bytes,2,opt,name=userId,proto3" json:"userId,omitempty"`
	TableId   string `protobuf:"bytes,3,opt,name=tableId,proto3" json:"tableId,omitempty"` // Sensitive word list id
...
type UpdateSensitiveWordTableReplyReq struct {
	...
	UserId  string `protobuf:"bytes,2,opt,name=userId,proto3" json:"userId,omitempty"`
	TableId string `protobuf:"bytes,3,opt,name=tableId,proto3" json:"tableId,omitempty"` // Sensitive word list id
	Reply   string `protobuf:"bytes,4,opt,name=Reply,proto3" json:"Reply,omitempty"`     // Reply settings
}
...
type DeleteSensitiveWordTableReq struct {
	...
	TableId string `protobuf:"bytes,1,opt,name=tableId,proto3" json:"tableId,omitempty"` // Sensitive word list id
}
...
type UploadSensitiveVocabularyReq struct {
	...
	OrgId         string `protobuf:"bytes,1,opt,name=orgId,proto3" json:"orgId,omitempty"`
	UserId        string `protobuf:"bytes,2,opt,name=userId,proto3" json:"userId,omitempty"`
	ImportType    string `protobuf:"bytes,3,opt,name=importType,proto3" json:"importType,omitempty"`       // Upload type
	Word          string `protobuf:"bytes,4,opt,name=word,proto3" json:"word,omitempty"`                   // Sensitive words
	SensitiveType string `protobuf:"bytes,5,opt,name=sensitiveType,proto3" json:"sensitiveType,omitempty"` // Sensitive word type
	TableId       string `protobuf:"bytes,6,opt,name=tableId,proto3" json:"tableId,omitempty"`             // Sensitive word list id
	FilePath      string `protobuf:"bytes,7,opt,name=filePath,proto3" json:"filePath,omitempty"`           // file path
}
...
type DeleteSensitiveVocabularyReq struct {
	...
	TableId string `protobuf:"bytes,1,opt,name=tableId,proto3" json:"tableId,omitempty"` // Sensitive word list id
	WordId  string `protobuf:"bytes,2,opt,name=wordId,proto3" json:"wordId,omitempty"`   // Sensitive word id
}
...
type GetSensitiveWordTableListByIDsReq struct {
	...
	TableIds []string `protobuf:"bytes,1,rep,name=tableIds,proto3" json:"tableIds,omitempty"` // Sensitive word list id
}
...
type SensitiveWordVocabulary struct {
	...
	Word          string `protobuf:"bytes,2,opt,name=word,proto3" json:"word,omitempty"`                   // Sensitive words
	SensitiveType string `protobuf:"bytes,3,opt,name=sensitiveType,proto3" json:"sensitiveType,omitempty"` // Sensitive word type
}
...
type SensitiveWordTableListWithWords struct {
	...
	Details []*SensitiveWordTableWithWords `protobuf:"bytes,1,rep,name=details,proto3" json:"details,omitempty"` // Sensitive word table with version data
}
