...
type AssistantConfigUpdateReq struct {
	...
	ModelConfig         *common.AppModelConfig        `protobuf:"bytes,5,opt,name=modelConfig,proto3" json:"modelConfig,omitempty"`                 // 模型配置 [EN] Model configuration
	KnowledgeBaseConfig *AssistantKnowledgeBaseConfig `protobuf:"bytes,6,opt,name=knowledgeBaseConfig,proto3" json:"knowledgeBaseConfig,omitempty"` // 知识库 [EN] knowledge base
	RerankConfig        *common.AppModelConfig        `protobuf:"bytes,7,opt,name=rerankConfig,proto3" json:"rerankConfig,omitempty"`               // Rerank模型 [EN] Rerank model
...
type AssistantKnowledgeBaseConfig struct {
	...
	KnowledgeBaseIds     []string            `protobuf:"bytes,1,rep,name=knowledgeBaseIds,proto3" json:"knowledgeBaseIds,omitempty"`     // 知识库信息 [EN] Knowledge base information
	MaxHistory           int32               `protobuf:"varint,2,opt,name=maxHistory,proto3" json:"maxHistory,omitempty"`                // 最长上下文 [EN] longest context
	Threshold            float32             `protobuf:"fixed32,3,opt,name=threshold,proto3" json:"threshold,omitempty"`                 // 过滤阈值 [EN] filter threshold
	TopK                 int32               `protobuf:"varint,4,opt,name=topK,proto3" json:"topK,omitempty"`                            // topK
	MatchType            string              `protobuf:"bytes,5,opt,name=matchType,proto3" json:"matchType,omitempty"`                   //matchType：vector（向量检索）、text（文本检索）、mix（混合检索：向量+文本） [EN] matchType: vector (vector search), text (text search), mix (mixed search: vector + text)
	KeywordPriority      float32             `protobuf:"fixed32,6,opt,name=keywordPriority,proto3" json:"keywordPriority,omitempty"`     // 关键词权重 [EN] Keyword weight
	PriorityMatch        int32               `protobuf:"varint,7,opt,name=priorityMatch,proto3" json:"priorityMatch,omitempty"`          // 权重匹配，只有在混合检索模式下，选择权重设置后，这个才设置为1 [EN] Weight matching. This is only set to 1 after selecting the weight setting in mixed search mode.
	SemanticsPriority    float32             `protobuf:"fixed32,8,opt,name=semanticsPriority,proto3" json:"semanticsPriority,omitempty"` // 语义权重 [EN] semantic weight
	TermWeight           float32             `protobuf:"fixed32,9,opt,name=termWeight,proto3" json:"termWeight,omitempty"`               // 关键词系数 [EN] keyword coefficient
	TermWeightEnable     bool                `protobuf:"varint,10,opt,name=termWeightEnable,proto3" json:"termWeightEnable,omitempty"`   // 关键词系数开关 [EN] Keyword coefficient switch
...
type AppKnowledgeBase struct {
	...
	GraphSwitch          int32                 `protobuf:"varint,3,opt,name=graphSwitch,proto3" json:"graphSwitch,omitempty"` // 知识图谱开关 [EN] Knowledge graph switch
...
type MetaDataFilterParams struct {
	...
	FilterLogicType  string              `protobuf:"bytes,2,opt,name=filterLogicType,proto3" json:"filterLogicType,omitempty"`   // 元数据逻辑条件：and/or [EN] Metadata logical conditions: and/or
	MetaFilterParams []*MetaFilterParams `protobuf:"bytes,3,rep,name=metaFilterParams,proto3" json:"metaFilterParams,omitempty"` // 元数据过滤参数列表 [EN] Metadata filter parameter list
}
...
type AssistantInfo struct {
	...
	ModelConfig         *common.AppModelConfig        `protobuf:"bytes,7,opt,name=modelConfig,proto3" json:"modelConfig,omitempty"`                 // 模型配置 [EN] Model configuration
	KnowledgeBaseConfig *AssistantKnowledgeBaseConfig `protobuf:"bytes,8,opt,name=knowledgeBaseConfig,proto3" json:"knowledgeBaseConfig,omitempty"` // 知识库 [EN] knowledge base
	RerankConfig        *common.AppModelConfig        `protobuf:"bytes,9,opt,name=rerankConfig,proto3" json:"rerankConfig,omitempty"`               // Rerank模型 [EN] Rerank model
