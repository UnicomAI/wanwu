...
type AppBrief struct {
	...
	AppType    string `protobuf:"bytes,4,opt,name=appType,proto3" json:"appType,omitempty"`       // Application type agent,rag,workflow
	AvatarPath string `protobuf:"bytes,5,opt,name=avatarPath,proto3" json:"avatarPath,omitempty"` // iconminio object path
	Name       string `protobuf:"bytes,6,opt,name=name,proto3" json:"name,omitempty"`
	Desc       string `protobuf:"bytes,7,opt,name=desc,proto3" json:"desc,omitempty"`
	CreatedAt  int64  `protobuf:"varint,8,opt,name=createdAt,proto3" json:"createdAt,omitempty"` // Creation time, millisecond timestamp
	UpdatedAt  int64  `protobuf:"varint,9,opt,name=updatedAt,proto3" json:"updatedAt,omitempty"` // Update time, millisecond timestamp
}
...
type ToolActionInputSchema struct {
	...
	Type       string                                 `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"` // Fixed object
