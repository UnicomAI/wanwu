...
type GetDocListReq struct {
	...
	MetaValue     string   `protobuf:"bytes,9,opt,name=metaValue,proto3" json:"metaValue,omitempty"`              // 元数据值过滤(string/number 类型)
	...
	MetaType      string   `protobuf:"bytes,12,opt,name=metaType,proto3" json:"metaType,omitempty"`               // 元数据类型: string/number/time，为空时按旧逻辑(metaValue 模糊匹配，排除 time 类型)
	MetaStartTime string   `protobuf:"bytes,13,opt,name=metaStartTime,proto3" json:"metaStartTime,omitempty"`     // metaType=time 时的起始时间戳(毫秒，字符串，与 metaValue 一致)
	MetaEndTime   string   `protobuf:"bytes,14,opt,name=metaEndTime,proto3" json:"metaEndTime,omitempty"`         // metaType=time 时的结束时间戳(毫秒，字符串，与 metaValue 一致)
}
...
func (x *GetDocListReq) GetMetaType() string {
	if x != nil {
		return x.MetaType
	}
	return ""
...
func (x *GetDocListReq) GetMetaStartTime() string {
	if x != nil {
		return x.MetaStartTime
	}
	return ""
}

func (x *GetDocListReq) GetMetaEndTime() string {
	if x != nil {
		return x.MetaEndTime
	}
	return ""
}
...
type GetDocListByDocIdListReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DocIdList []string `protobuf:"bytes,1,rep,name=docIdList,proto3" json:"docIdList,omitempty"`
	UserId    string   `protobuf:"bytes,2,opt,name=userId,proto3" json:"userId,omitempty"`
	OrgId     string   `protobuf:"bytes,3,opt,name=orgId,proto3" json:"orgId,omitempty"`
}

func (x *GetDocListByDocIdListReq) Reset() {
	*x = GetDocListByDocIdListReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetDocListByDocIdListReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDocListByDocIdListReq) ProtoMessage() {}

func (x *GetDocListByDocIdListReq) ProtoReflect() protoreflect.Message {
	mi := &file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDocListByDocIdListReq.ProtoReflect.Descriptor instead.
func (*GetDocListByDocIdListReq) Descriptor() ([]byte, []int) {
	return file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_rawDescGZIP(), []int{2}
}

func (x *GetDocListByDocIdListReq) GetDocIdList() []string {
	if x != nil {
		return x.DocIdList
	}
	return nil
...
func (x *GetDocListByDocIdListReq) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *GetDocListByDocIdListReq) GetOrgId() string {
	if x != nil {
		return x.OrgId
	}
	return ""
...
type KnowledgeInfo struct {
	...
	PermissionType   int32           `protobuf:"varint,11,opt,name=permissionType,proto3" json:"permissionType,omitempty"`   // 当前用户对该知识库的权限类型 -1:无权限 0:查看 10:编辑 20:授权 30:系统管理授权
}
...
func (x *DeleteDocReq) GetKnowledgeId() string {
	if x != nil {
		return x.KnowledgeId
	}
	return ""
...
type DocSegmentListResp struct {
	...
	AsrModelId          string            `protobuf:"bytes,13,opt,name=asrModelId,proto3" json:"asrModelId,omitempty"`               // ASR模型ID
	MultimodalModelId   string            `protobuf:"bytes,14,opt,name=multimodalModelId,proto3" json:"multimodalModelId,omitempty"` // 图文问答模型ID
	ParserModelId       string            `protobuf:"bytes,15,opt,name=parserModelId,proto3" json:"parserModelId,omitempty"`         // OCR/模型解析 模型ID
	DownloadUrl         string            `protobuf:"bytes,16,opt,name=downloadUrl,proto3" json:"downloadUrl,omitempty"`             // 文档对外下载地址(RAG 返回的可用链接)
	CanPreview          bool              `protobuf:"varint,17,opt,name=canPreview,proto3" json:"canPreview,omitempty"`              // 是否可预览
	PreviewFailReason   string            `protobuf:"bytes,18,opt,name=previewFailReason,proto3" json:"previewFailReason,omitempty"` // 不可预览原因
	DocSize             int64             `protobuf:"varint,19,opt,name=docSize,proto3" json:"docSize,omitempty"`                    // 文档大小，单位字节(Byte)
}
...
func (x *DocSegmentListResp) GetAsrModelId() string {
	if x != nil {
		return x.AsrModelId
	}
	return ""
...
func (x *DocSegmentListResp) GetMultimodalModelId() string {
	if x != nil {
		return x.MultimodalModelId
	}
	return ""
...
func (x *DocSegmentListResp) GetParserModelId() string {
	if x != nil {
		return x.ParserModelId
	}
	return ""
}

func (x *DocSegmentListResp) GetDownloadUrl() string {
	if x != nil {
...
func (x *DocSegmentListResp) GetCanPreview() bool {
	if x != nil {
		return x.CanPreview
	}
	return false
...
func (x *DocSegmentListResp) GetPreviewFailReason() string {
	if x != nil {
		return x.PreviewFailReason
	}
	return ""
}

func (x *DocSegmentListResp) GetDocSize() int64 {
	if x != nil {
		return x.DocSize
	}
	return 0
...
type DocInfo struct {
	...
	DocProgress   int32          `protobuf:"varint,15,opt,name=docProgress,proto3" json:"docProgress,omitempty"`     //文档解析进度百分比 (0-100)
	GraphProgress int32          `protobuf:"varint,16,opt,name=graphProgress,proto3" json:"graphProgress,omitempty"` //图谱解析进度百分比 (0-100)
}
...
func (x *DocInfo) GetDocProgress() int32 {
	if x != nil {
		return x.DocProgress
	}
	return 0
}

func (x *DocInfo) GetGraphProgress() int32 {
	if x != nil {
		return x.GraphProgress
	}
	return 0
}
...
func (x *FileTypeLimit) Reset() {
	*x = FileTypeLimit{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_msgTypes[43]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FileTypeLimit) Descriptor() ([]byte, []int) {
	return file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_rawDescGZIP(), []int{43}
}
...
var file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x03, 0x0a, 0x0d, 0x47, 0x65,
	...
	,
	...
	0x72, 0x67, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x6e, 0x65, 0x65, 0x64, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x6e, 0x65, 0x65, 0x64, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x22, 0x66, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x44, 0x6f, 0x63, 0x4c, 0x69,
	0x73, 0x74, 0x42, 0x79, 0x44, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71,
	0x12, 0x1c, 0x0a, 0x09, 0x64, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x09, 0x64, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x16,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x72, 0x67, 0x49, 0x64, 0x22, 0xe4, 0x01, 0x0a,
	0x0e, 0x47, 0x65, 0x74, 0x44, 0x6f, 0x63, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12,
	0x36, 0x0a, 0x04, 0x64, 0x6f, 0x63, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e,
	...
	0x6f, 0x52, 0x04, 0x64, 0x6f, 0x63, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c,
	...
	0x69, 0x7a, 0x65, 0x12, 0x4e, 0x0a, 0x0d, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65,
	0x49, 0x6e, 0x66, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6b, 0x6e, 0x6f,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0d, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x49,
	0x6e, 0x66, 0x6f, 0x22, 0xba, 0x03, 0x0a, 0x0d, 0x4b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67,
	...
	,
	...
	,
	...
	,
	...
	0x71, 0x52, 0x0c, 0x69, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x44, 0x6f, 0x63, 0x52, 0x65, 0x71, 0x12,
	0x1c, 0x0a, 0x09, 0x64, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x09, 0x64, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x20, 0x0a,
	...
	0x7e, 0x0a, 0x0e, 0x52, 0x65, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x44, 0x6f, 0x63, 0x52, 0x65,
	...
	0x64, 0x12, 0x1c, 0x0a, 0x09, 0x64, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x04,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x64, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22,
	0x7c, 0x0a, 0x0c, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x44, 0x6f, 0x63, 0x52, 0x65, 0x71, 0x12,
	...
	0x1c, 0x0a, 0x09, 0x64, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x09, 0x64, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x67, 0x0a,
	0x0b, 0x44, 0x6f, 0x63, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x12, 0x10, 0x0a, 0x03,
	...
	0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x75, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x72, 0x75, 0x6c, 0x65, 0x22, 0x8b, 0x01, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x44, 0x6f, 0x63, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x12, 0x14, 0x0a,
	...
	0x01, 0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x47, 0x0a, 0x0c, 0x6d,
	0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x23, 0x2e, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x62, 0x61, 0x73,
	0x65, 0x5f, 0x64, 0x6f, 0x63, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4d, 0x65,
	0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x52, 0x0c, 0x6d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61,
	0x4c, 0x69, 0x73, 0x74, 0x22, 0xc5, 0x01, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44,
	0x6f, 0x63, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x12, 0x14, 0x0a,
	...
	0x64, 0x12, 0x47, 0x0a, 0x0c, 0x6d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73,
	0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65,
	...
	0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x6b, 0x6e,
	0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x49, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0b, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x49, 0x64, 0x22, 0xea, 0x01, 0x0a,
	0x19, 0x42, 0x61, 0x74, 0x63, 0x68, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x6f, 0x63, 0x4d,
	0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x72,
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x54,
	0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04,
	0x72, 0x75, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x75, 0x6c, 0x65,
	0x22, 0x40, 0x0a, 0x10, 0x49, 0x6e, 0x69, 0x74, 0x44, 0x6f, 0x63, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x49, 0x64, 0x22, 0x70, 0x0a, 0x0c, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x44, 0x6f, 0x63, 0x52,
	0x65, 0x71, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x03, 0x69, 0x64, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05,
	...
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64,
	0x67, 0x65, 0x49, 0x64, 0x22, 0x89, 0x01, 0x0a, 0x0b, 0x44, 0x6f, 0x63, 0x46, 0x69, 0x6c, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x70, 0x61, 0x67, 0x65, 0x4e, 0x6f, 0x12, 0x18,
	0x0a, 0x07, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xb5, 0x01, 0x0a, 0x19, 0x55, 0x70, 0x64,
	...
	0x7d, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x44, 0x6f, 0x63, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x53, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x79, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x44, 0x6f, 0x63, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x79, 0x44,
	0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x33, 0x2e, 0x6b, 0x6e, 0x6f, 0x77, 0x6c,
	0x65, 0x64, 0x67, 0x65, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x64, 0x6f, 0x63, 0x5f, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x6f, 0x63, 0x4c, 0x69, 0x73, 0x74, 0x42,
	0x79, 0x44, 0x6f, 0x63, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x29, 0x2e,
	0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x64, 0x6f,
	...
	0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74,
	0x79, 0x22, 0x00, 0x12, 0x5c, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x44, 0x6f, 0x63, 0x55, 0x70, 0x6c,
	0x6f, 0x61, 0x64, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	...
	0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22,
...
var file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_goTypes = []interface{}{
	...
	(*GetDocListByDocIdListReq)(nil),   // 2: knowledgebase_doc_service.GetDocListByDocIdListReq
	(*GetDocListResp)(nil),             // 3: knowledgebase_doc_service.GetDocListResp
	(*KnowledgeInfo)(nil),              // 4: knowledgebase_doc_service.KnowledgeInfo
	(*KeywordsInfo)(nil),               // 5: knowledgebase_doc_service.KeywordsInfo
	(*ImportDocReq)(nil),               // 6: knowledgebase_doc_service.ImportDocReq
	(*UpdateDocImportConfigReq)(nil),   // 7: knowledgebase_doc_service.UpdateDocImportConfigReq
	(*ReImportDocReq)(nil),             // 8: knowledgebase_doc_service.ReImportDocReq
	(*ExportDocReq)(nil),               // 9: knowledgebase_doc_service.ExportDocReq
	(*DocMetaData)(nil),                // 10: knowledgebase_doc_service.DocMetaData
	(*UpdateDocStatusReq)(nil),         // 11: knowledgebase_doc_service.UpdateDocStatusReq
	(*UpdateDocMetaDataReq)(nil),       // 12: knowledgebase_doc_service.UpdateDocMetaDataReq
	(*BatchUpdateDocMetaDataReq)(nil),  // 13: knowledgebase_doc_service.BatchUpdateDocMetaDataReq
	(*MetaData)(nil),                   // 14: knowledgebase_doc_service.MetaData
	(*InitDocStatusReq)(nil),           // 15: knowledgebase_doc_service.InitDocStatusReq
	(*DeleteDocReq)(nil),               // 16: knowledgebase_doc_service.DeleteDocReq
	(*DocFileInfo)(nil),                // 17: knowledgebase_doc_service.DocFileInfo
	(*DocSegment)(nil),                 // 18: knowledgebase_doc_service.DocSegment
	(*DocImportTipReq)(nil),            // 19: knowledgebase_doc_service.DocImportTipReq
	(*DocImportTipResp)(nil),           // 20: knowledgebase_doc_service.DocImportTipResp
	(*DocSegmentListResp)(nil),         // 21: knowledgebase_doc_service.DocSegmentListResp
	(*SegmentContent)(nil),             // 22: knowledgebase_doc_service.SegmentContent
	(*DocInfo)(nil),                    // 23: knowledgebase_doc_service.DocInfo
	(*DocConfigInfo)(nil),              // 24: knowledgebase_doc_service.DocConfigInfo
	(*DocSegmentListReq)(nil),          // 25: knowledgebase_doc_service.DocSegmentListReq
	(*UpdateDocSegmentStatusReq)(nil),  // 26: knowledgebase_doc_service.UpdateDocSegmentStatusReq
	(*AnalysisUrlDocReq)(nil),          // 27: knowledgebase_doc_service.AnalysisUrlDocReq
	(*AnalysisUrlDocResp)(nil),         // 28: knowledgebase_doc_service.AnalysisUrlDocResp
	(*UrlInfo)(nil),                    // 29: knowledgebase_doc_service.UrlInfo
	(*DocSegmentLabelsReq)(nil),        // 30: knowledgebase_doc_service.DocSegmentLabelsReq
	(*CreateDocSegmentReq)(nil),        // 31: knowledgebase_doc_service.CreateDocSegmentReq
	(*BatchCreateDocSegmentReq)(nil),   // 32: knowledgebase_doc_service.BatchCreateDocSegmentReq
	(*DeleteDocSegmentReq)(nil),        // 33: knowledgebase_doc_service.DeleteDocSegmentReq
	(*UpdateDocSegmentReq)(nil),        // 34: knowledgebase_doc_service.UpdateDocSegmentReq
	(*GetDocChildSegmentListReq)(nil),  // 35: knowledgebase_doc_service.GetDocChildSegmentListReq
	(*GetDocChildSegmentListResp)(nil), // 36: knowledgebase_doc_service.GetDocChildSegmentListResp
	(*ChildSegmentInfo)(nil),           // 37: knowledgebase_doc_service.ChildSegmentInfo
	(*CreateDocChildSegmentReq)(nil),   // 38: knowledgebase_doc_service.CreateDocChildSegmentReq
	(*DeleteDocChildSegmentReq)(nil),   // 39: knowledgebase_doc_service.DeleteDocChildSegmentReq
	(*UpdateDocChildSegmentReq)(nil),   // 40: knowledgebase_doc_service.UpdateDocChildSegmentReq
	(*ChildChunk)(nil),                 // 41: knowledgebase_doc_service.ChildChunk
	(*DocUploadLimitResp)(nil),         // 42: knowledgebase_doc_service.DocUploadLimitResp
	(*FileTypeLimit)(nil),              // 43: knowledgebase_doc_service.FileTypeLimit
	(*emptypb.Empty)(nil),              // 44: google.protobuf.Empty
}
var file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_depIdxs = []int32{
	23, // 0: knowledgebase_doc_service.GetDocListResp.docs:type_name -> knowledgebase_doc_service.DocInfo
	4,  // 1: knowledgebase_doc_service.GetDocListResp.knowledgeInfo:type_name -> knowledgebase_doc_service.KnowledgeInfo
	5,  // 2: knowledgebase_doc_service.KnowledgeInfo.keywords:type_name -> knowledgebase_doc_service.KeywordsInfo
	17, // 3: knowledgebase_doc_service.ImportDocReq.docInfoList:type_name -> knowledgebase_doc_service.DocFileInfo
	18, // 4: knowledgebase_doc_service.ImportDocReq.docSegment:type_name -> knowledgebase_doc_service.DocSegment
	10, // 5: knowledgebase_doc_service.ImportDocReq.docMetaDataList:type_name -> knowledgebase_doc_service.DocMetaData
	6,  // 6: knowledgebase_doc_service.UpdateDocImportConfigReq.importDocReq:type_name -> knowledgebase_doc_service.ImportDocReq
	14, // 7: knowledgebase_doc_service.UpdateDocStatusReq.metaDataList:type_name -> knowledgebase_doc_service.MetaData
	14, // 8: knowledgebase_doc_service.UpdateDocMetaDataReq.metaDataList:type_name -> knowledgebase_doc_service.MetaData
	14, // 9: knowledgebase_doc_service.BatchUpdateDocMetaDataReq.metaDataList:type_name -> knowledgebase_doc_service.MetaData
	22, // 10: knowledgebase_doc_service.DocSegmentListResp.contentList:type_name -> knowledgebase_doc_service.SegmentContent
	14, // 11: knowledgebase_doc_service.DocSegmentListResp.metaDataList:type_name -> knowledgebase_doc_service.MetaData
	24, // 12: knowledgebase_doc_service.DocInfo.docConfigInfo:type_name -> knowledgebase_doc_service.DocConfigInfo
	18, // 13: knowledgebase_doc_service.DocConfigInfo.docSegment:type_name -> knowledgebase_doc_service.DocSegment
	29, // 14: knowledgebase_doc_service.AnalysisUrlDocResp.urlList:type_name -> knowledgebase_doc_service.UrlInfo
	37, // 15: knowledgebase_doc_service.GetDocChildSegmentListResp.contentList:type_name -> knowledgebase_doc_service.ChildSegmentInfo
	41, // 16: knowledgebase_doc_service.UpdateDocChildSegmentReq.childChunk:type_name -> knowledgebase_doc_service.ChildChunk
	43, // 17: knowledgebase_doc_service.DocUploadLimitResp.list:type_name -> knowledgebase_doc_service.FileTypeLimit
	0,  // 18: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocList:input_type -> knowledgebase_doc_service.GetDocListReq
	2,  // 19: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocListByDocIdList:input_type -> knowledgebase_doc_service.GetDocListByDocIdListReq
	1,  // 20: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocDetail:input_type -> knowledgebase_doc_service.GetDocDetailReq
	6,  // 21: knowledgebase_doc_service.KnowledgeBaseDocService.ImportDoc:input_type -> knowledgebase_doc_service.ImportDocReq
	8,  // 22: knowledgebase_doc_service.KnowledgeBaseDocService.ReImportDoc:input_type -> knowledgebase_doc_service.ReImportDocReq
	7,  // 23: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocImportConfig:input_type -> knowledgebase_doc_service.UpdateDocImportConfigReq
	9,  // 24: knowledgebase_doc_service.KnowledgeBaseDocService.ExportDoc:input_type -> knowledgebase_doc_service.ExportDocReq
	11, // 25: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocStatus:input_type -> knowledgebase_doc_service.UpdateDocStatusReq
	12, // 26: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocMetaData:input_type -> knowledgebase_doc_service.UpdateDocMetaDataReq
	13, // 27: knowledgebase_doc_service.KnowledgeBaseDocService.BatchUpdateDocMetaData:input_type -> knowledgebase_doc_service.BatchUpdateDocMetaDataReq
	15, // 28: knowledgebase_doc_service.KnowledgeBaseDocService.InitDocStatus:input_type -> knowledgebase_doc_service.InitDocStatusReq
	16, // 29: knowledgebase_doc_service.KnowledgeBaseDocService.DeleteDoc:input_type -> knowledgebase_doc_service.DeleteDocReq
	19, // 30: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocCategoryUploadTip:input_type -> knowledgebase_doc_service.DocImportTipReq
	25, // 31: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocSegmentList:input_type -> knowledgebase_doc_service.DocSegmentListReq
	26, // 32: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocSegmentStatus:input_type -> knowledgebase_doc_service.UpdateDocSegmentStatusReq
	27, // 33: knowledgebase_doc_service.KnowledgeBaseDocService.AnalysisDocUrl:input_type -> knowledgebase_doc_service.AnalysisUrlDocReq
	30, // 34: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocSegmentLabels:input_type -> knowledgebase_doc_service.DocSegmentLabelsReq
	31, // 35: knowledgebase_doc_service.KnowledgeBaseDocService.CreateDocSegment:input_type -> knowledgebase_doc_service.CreateDocSegmentReq
	32, // 36: knowledgebase_doc_service.KnowledgeBaseDocService.BatchCreateDocSegment:input_type -> knowledgebase_doc_service.BatchCreateDocSegmentReq
	33, // 37: knowledgebase_doc_service.KnowledgeBaseDocService.DeleteDocSegment:input_type -> knowledgebase_doc_service.DeleteDocSegmentReq
	34, // 38: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocSegment:input_type -> knowledgebase_doc_service.UpdateDocSegmentReq
	35, // 39: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocChildSegmentList:input_type -> knowledgebase_doc_service.GetDocChildSegmentListReq
	38, // 40: knowledgebase_doc_service.KnowledgeBaseDocService.CreateDocChildSegment:input_type -> knowledgebase_doc_service.CreateDocChildSegmentReq
	39, // 41: knowledgebase_doc_service.KnowledgeBaseDocService.DeleteDocChildSegment:input_type -> knowledgebase_doc_service.DeleteDocChildSegmentReq
	40, // 42: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocChildSegment:input_type -> knowledgebase_doc_service.UpdateDocChildSegmentReq
	44, // 43: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocUploadLimit:input_type -> google.protobuf.Empty
	3,  // 44: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocList:output_type -> knowledgebase_doc_service.GetDocListResp
	3,  // 45: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocListByDocIdList:output_type -> knowledgebase_doc_service.GetDocListResp
	23, // 46: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocDetail:output_type -> knowledgebase_doc_service.DocInfo
	44, // 47: knowledgebase_doc_service.KnowledgeBaseDocService.ImportDoc:output_type -> google.protobuf.Empty
	44, // 48: knowledgebase_doc_service.KnowledgeBaseDocService.ReImportDoc:output_type -> google.protobuf.Empty
	44, // 49: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocImportConfig:output_type -> google.protobuf.Empty
	44, // 50: knowledgebase_doc_service.KnowledgeBaseDocService.ExportDoc:output_type -> google.protobuf.Empty
	44, // 51: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocStatus:output_type -> google.protobuf.Empty
	44, // 52: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocMetaData:output_type -> google.protobuf.Empty
	44, // 53: knowledgebase_doc_service.KnowledgeBaseDocService.BatchUpdateDocMetaData:output_type -> google.protobuf.Empty
	44, // 54: knowledgebase_doc_service.KnowledgeBaseDocService.InitDocStatus:output_type -> google.protobuf.Empty
	44, // 55: knowledgebase_doc_service.KnowledgeBaseDocService.DeleteDoc:output_type -> google.protobuf.Empty
	20, // 56: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocCategoryUploadTip:output_type -> knowledgebase_doc_service.DocImportTipResp
	21, // 57: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocSegmentList:output_type -> knowledgebase_doc_service.DocSegmentListResp
	44, // 58: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocSegmentStatus:output_type -> google.protobuf.Empty
	28, // 59: knowledgebase_doc_service.KnowledgeBaseDocService.AnalysisDocUrl:output_type -> knowledgebase_doc_service.AnalysisUrlDocResp
	44, // 60: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocSegmentLabels:output_type -> google.protobuf.Empty
	44, // 61: knowledgebase_doc_service.KnowledgeBaseDocService.CreateDocSegment:output_type -> google.protobuf.Empty
	44, // 62: knowledgebase_doc_service.KnowledgeBaseDocService.BatchCreateDocSegment:output_type -> google.protobuf.Empty
	44, // 63: knowledgebase_doc_service.KnowledgeBaseDocService.DeleteDocSegment:output_type -> google.protobuf.Empty
	44, // 64: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocSegment:output_type -> google.protobuf.Empty
	36, // 65: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocChildSegmentList:output_type -> knowledgebase_doc_service.GetDocChildSegmentListResp
	44, // 66: knowledgebase_doc_service.KnowledgeBaseDocService.CreateDocChildSegment:output_type -> google.protobuf.Empty
	44, // 67: knowledgebase_doc_service.KnowledgeBaseDocService.DeleteDocChildSegment:output_type -> google.protobuf.Empty
	44, // 68: knowledgebase_doc_service.KnowledgeBaseDocService.UpdateDocChildSegment:output_type -> google.protobuf.Empty
	42, // 69: knowledgebase_doc_service.KnowledgeBaseDocService.GetDocUploadLimit:output_type -> knowledgebase_doc_service.DocUploadLimitResp
...
func file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDocListByDocIdListReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_knowledgebase_doc_service_knowledgebase_doc_service_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
