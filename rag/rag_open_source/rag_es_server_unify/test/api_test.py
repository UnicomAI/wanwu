...
if __name__ == "__main__":
    ...
    # 构造请求数据 [EN] Construct request data
    data = {
        "userId": user_id,
        "kb_name": kb_name,
    }
    # 发送 POST 请求 [EN] Send POST request
    response = requests.post(url, headers=headers, json=data)  # 直接使用json参数发送JSON数据 [EN] Send JSON data directly using json parameters
