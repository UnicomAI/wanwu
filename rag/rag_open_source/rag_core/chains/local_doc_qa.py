...
def extract_text_from_xml(input_xml_path):
    ...
    """
    # Get the directory and file name of the input file (without extension)
    ...
    # Recursively traverse the XML tree and extract the text content
    def recurse_extract_text(element):
        # Collects the text content of the current element (if any)
...
#     """Returns two lists. The first list is the full path of all files under filepath, and the second is the corresponding file name"""
