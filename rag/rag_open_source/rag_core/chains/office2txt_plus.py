...
def extract_text_from_doc(doc_file_path, output_file_path):
    # Only supports .doc documents saved in MS Office 2007 and later\
    # Install dependencies: apt-get install catdoc
    full_text = os.popen("catdoc -s='utf-8' -d='utf-8' " + doc_file_path).read()
    with open(output_file_path, "w", encoding='utf-8') as file:
        file.write(full_text)
    # print(f"PDF file {doc_file_path} has been successfully processed.")
...
def extract_text_from_pdf(pdf_file_path, output_file_path):
    ...
    with open(output_file_path, "w", encoding='utf-8') as file:
        file.write(full_text)
    # print(f"PDF file {pdf_file_path} has been successfully processed.")
...
def extract_text_from_pptx(ppt_file_path, output_file_path):
    ...
    with open(output_file_path, "w", encoding='utf-8') as file:
        file.write(full_text)
    # print(f"PPT file {ppt_file_path} has been successfully processed.")
