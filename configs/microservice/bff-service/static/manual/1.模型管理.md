...
针对支持切换“深度思考”开关的模型，可选择“支持”。后续在智能体等应用构建时，可在配置模型参数时，切换深度思考功能的开启和关闭。选择“支持”后，会自动开启校验，测试成功后，才可以进行后续模型导入校验。

![image-20260318162926268](assets/image-20260318162926268.png)

![image-20260417102826045](assets/image-20260417102826045.png)

![image-20260319162427399](assets/image-20260319162427399.png)
...
```bash
curl --location --request POST 'https://maas-api.ai-yuanjing.com/openapi/v1/rag/model_parser_file' \
--header 'Authorization: Bearer api-key' \
--header 'Content-Type: multipart/form-data; boundary=--------------------------531334581410407490745024' \
--form 'file=@"/home/file/xxx.pdf"' \
...
```bash
{
    ...
    "content": "文本内容",
    "json_content": "",
    "trace_id": "8453b9cd-9b38-43ae-a55a-5ce022293736-0",
    "version": "pubcloud",
    "result": {
        "md_content": null,
        "json_content": null,
